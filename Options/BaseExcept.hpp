...
-Member Functions:
	...
	*~BaseExcept():	Destructor.
	// Misc. Methods:
	*string DerivedMessage() const: Return message in base class to derived class.
	*string GetMessage() const: PVMF to make BaseExcept an abstract base class.
*/
...
namespace Options
{
	namespace Exceptions
	{
		...
		public:
			...
			// Misc. Methods:
			////////////////////////////
			virtual std::string GetMessage() const = 0;				/* PVMF, makes class an abstract base class. */
			////////////////////////////
